...
import com.example.minigamestada.MainActivity;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private void sendNotification(String messageBody, String messageTitle) {
        ...
        expandedView.setTextViewText(R.id.tvNotificationTitle_E, messageTitle);
        expandedView.setTextViewText(R.id.tvNotificationDescription_E, messageBody);
